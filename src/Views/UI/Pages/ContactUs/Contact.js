...
const Contact = () => {
    ...
    return <>
        ...
        <Container maxWidth="lg" sx={{
            ...
            >
                <Grid item xl="6" md="6" xs="12"  >
                    <Box sx={{ width: { md: '90%', xs: '90%' }, padding: '20px', background: '#227AEB', borderRadius: '20px' }}>
                ...
                <Grid item xl="6" md="6" xs="12" sx={{ marginTop: { md: '0', xs: '40px' }, padding: { md: '50px', xs: '20px' }, height: 'auto' }}>
                    ...
                    <Box color="#000" display="flex" gap="20px" alignItems="center">
                        <PhoneInTalkIcon />
                        <a href="tel:+61 (04) 26092609" style={{ textDecoration: 'none' }}>
                    ...
                    <Box color="#000" display="flex" gap="20px" alignItems="center">
                        <MarkEmailReadIcon />
                        <a href="mailto:Info@lilprogram.com" style={{ textDecoration: 'none' }}>
                            <Typography sx={{ fontWeight: "500", fontSize: { md: "20px", xs: '16px' }, lineHeight: "59px", color: " #000" }}>
                                Info@lilprogram.com
                            </Typography>
                        </a>
                    ...
                    <br />
                    <a target="_blank" rel="noreferrer" href="https://maps.app.goo.gl/jwA2Jqn2B2XeAT2a9" style={{ textDecoration: 'none' }}>
                        <Box color="#000" display="flex" gap="20px" alignItems="flex-start">
                            <AddLocationAltIcon />
                            <Typography sx={{ fontWeight: "500", fontSize: { md: "20px", xs: '16px' }, color: " #000" }}>
                                Harrisdale, Perth 6112
                            </Typography>
                        </Box>
                    </a>
                    <Box sx={{ marginTop: { md: '60px', xs: '10px' } }}>
                        <a target="_blank" rel="noreferrer" href="https://www.facebook.com/profile.php?id=61554891894211">
                            <img src={require("../../../Assets/contact/newsocial (1).png")} alt=""   />
                        </a>
                        <a target="_blank" rel="noreferrer" href="https://www.instagram.com/leadinlifeprogramm?igsh=Z3Z5ZXN2MjdpYThh">
                            <img src={require("../../../Assets/contact/newsocial (2).png")} alt=""   />
                        </a>
                        <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/lil-program-aab1182a7/">
                            <img src={require("../../../Assets/contact/newsocial (3).png")} alt=""   />
                        </a>
                        <a target="_blank" rel="noreferrer" href="https://youtube.com/@lilprogram?si=TQJGdvT1pvy0U4EF">
