        ...
        <Grid item xl="5" md="5" xs="12"  >
          <Slide bottom>
            ...
            <Typography sx={{ fontWeight: "500", fontSize: { md: "20px", xs: '16px' }, lineHeight: "32px", color: "#565656" }}>
              Where Young Minds Forge Their Own Path of Thought.
            </Typography>
            <br />
        ...
        <Grid item xl="5" md="5" xs="12"  >
          <Slide bottom>
            ...
            <Typography sx={{ fontWeight: "500", fontSize: { md: "20px", xs: '16px' }, lineHeight: "32px", color: "rgba(27, 27, 27, 0.6)" }}>
              Where Children Find Their Voice with Confidence.
            </Typography>
            <br />
      ...
      >
        ...
        <Grid item xl="5" md="5" xs="12"  >
          <Slide bottom>
            ...
            <Typography sx={{ fontWeight: "500", fontSize: { md: "20px", xs: '16px' }, lineHeight: "32px", color: "rgba(27, 27, 27, 0.6)" }}>
              Where Children Evolve into Collaborative Leaders.
            </Typography>
            <br />
            {workable.map((item, i) => (
...
const ThinkAble = [
  {
    count: '01',
    title: 'Dive deep with analytical thinking.'
  },
  {
    count: '02',
  ...
  {
    count: '03',
    title: 'Overcome challenges using problem-solving.'
  },
  {
    count: '04',
    title: 'See through multiple perspectives with critical analysis.'
  },
  {
    count: '05',
    title: 'Future-focused innovative design.'
  },
]
...
const Speakable = [
  ...
  {
    count: '02',
    title: 'Embrace theatrical arts for full expression.'
  },
  {
    count: '03',
    title: 'Master vocabulary for effective communication.'
  },
  {
    count: '04',
    title: 'Present ideas with unmatched confidence.'
  },
  {
    count: '05',
    title: 'Articulate clearly and effectively.'
  },
]
const workable = [
  {
    count: '01',
    title: 'Ignite the entrepreneur spirit early on'
  },
  {
    count: '02',
    title: 'Harness potential with business insights for young minds.'
  },
  {
    count: '03',
    title: 'Enhance productivity with time management tricks.'
  },
  {
    count: '04',
    title: 'Build social connections and understand emotional cues.'
  },
  {
    count: '05',
    title: 'Equip with life skills for everyday challenges.'
  },
]